-- Dark Sky 8.8.6 through 8.8.15.6 — Admiral Commissioning Orders, Vessel Logo Helm, and Supabase Keel
...
-- 8.8.15.6 Supabase Keel neutral settings seed. This is intentionally not an
