...
# Dark Sky 6.0.1 — Drydock Refit Repository Reconciliation
...
If older full-app files remain under GitHub `/assets`, remove only the non-media duplicates from that folder after the 6.0.1 root deployment is confirmed. Do not delete current logo/image assets.
