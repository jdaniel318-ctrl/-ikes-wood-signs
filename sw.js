const CACHE='dark-sky-v5-8-1-helmfix';
const ASSETS=[
  './',
  './index.html',
  './styles.css?v=5.8.1',
  './platform_core.js?v=5.8.1',
  './platform_v4.js?v=5.8.1',
  './platform_identity.js?v=5.8.1',
  './app.js?v=5.8.1',
  './captain.js?v=5.8.1',
  ...
  './assets/captains_quarters_clean_room_v580.png',
