# Dark Sky 4.8.4 — BOR Commissioning Audit
...
## Admission guard
- BOR is the only new Project ID explicitly admitted by the 4.8.4 release migration.
...
- Service worker build/cache advanced to 4.8.4: PASS.
