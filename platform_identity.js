/* Dark Sky 8.8.14.2 — Centerline: contained iPad Signal Report rendering. */
(function(g){
'use strict';
const BUILD='8.8.14.2';
...
g.BlackFlagV3Identity={version:'8.8.14.2-true-course',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
