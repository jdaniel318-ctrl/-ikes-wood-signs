/* Dark Sky 8.8.0 — Command Spine: one authoritative Engine/Captain/Admiral route contract. */
(function(g){
'use strict';
const BUILD='8.8.0';
...
g.BlackFlagV3Identity={version:'8.8.0-command-spine',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
