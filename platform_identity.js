/* Dark Sky 8.8.1 — Open Channel: one authoritative Engine/Captain/Admiral route contract. */
(function(g){
'use strict';
const BUILD='8.8.1';
...
g.BlackFlagV3Identity={version:'8.8.1-open-channel',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
