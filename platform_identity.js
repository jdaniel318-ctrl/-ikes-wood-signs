/* Dark Sky 8.6.46 — Fleet Ownership Charter: live staging identity; Dark Sky grants fleet authority. */
(function(g){
'use strict';
const BUILD='8.6.46';
...
g.BlackFlagV3Identity={version:'8.6.46-fleet-ownership-charter',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
