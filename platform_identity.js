/* Dark Sky 8.8.17 — Admiral Commission: governed Fleet Launch Service. */
(function(g){
'use strict';
const BUILD='8.8.17.10';
...
g.BlackFlagV3Identity={version:'8.8.17.10-ledger-recovery-keel',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
