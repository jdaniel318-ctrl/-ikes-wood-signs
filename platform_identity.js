/* Dark Sky 8.8.16 — Cleanup Keel: governed Fleet Launch Service. */
(function(g){
'use strict';
const BUILD='8.8.16';
...
g.BlackFlagV3Identity={version:'8.8.16-report-proof',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
