/* Dark Sky 8.8.14.3 — Exact Arrival: protected Captain deployment handoff. */
(function(g){
'use strict';
const BUILD='8.8.14.3';
...
g.BlackFlagV3Identity={version:'8.8.14.3-true-course',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
