/* Dark Sky 8.8.15.1 — Fleet Runtime: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.15.1';
...
g.BlackFlagV3Identity={version:'8.8.15.1-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
