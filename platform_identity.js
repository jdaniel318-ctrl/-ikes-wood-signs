/* Dark Sky 8.7.10 — Held Course: verified identity with stable iPad keyboard scroll continuity. */
(function(g){
'use strict';
const BUILD='8.7.10';
...
g.BlackFlagV3Identity={version:'8.7.10-held-course',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
