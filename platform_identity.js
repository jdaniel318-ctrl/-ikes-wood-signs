/* Dark Sky 8.6.53 — Fleet Services Framework: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.53';
...
g.BlackFlagV3Identity={version:'8.6.53-owner-bridge',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
