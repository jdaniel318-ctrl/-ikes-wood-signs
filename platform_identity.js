/* Dark Sky 8.8.14.17 — Fleet Velocity: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.17';
...
g.BlackFlagV3Identity={version:'8.8.14.17-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
