/* Dark Sky 8.7.13 — True Return: guarded iPad pointer release with canonical Engine restoration. */
(function(g){
'use strict';
const BUILD='8.7.13';
...
g.BlackFlagV3Identity={version:'8.7.13-true-return',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
