/* Dark Sky 8.6.50 — Direct Login Relay: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.50';
...
g.BlackFlagV3Identity={version:'8.6.50-rls-landing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
