/* Dark Sky 8.8.14.21 — Kiosk Watch: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.21';
...
g.BlackFlagV3Identity={version:'8.8.14.21-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
