/* Dark Sky 8.8.11.4 — Native Passage: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.11.4';
...
g.BlackFlagV3Identity={version:'8.8.11.4-natural-schedule',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
