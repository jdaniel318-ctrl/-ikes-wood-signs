/* Dark Sky 8.8.10 — Native Passage: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.10';
...
g.BlackFlagV3Identity={version:'8.8.10-command-acknowledgment',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
