/* Dark Sky 8.8.13.2 — Clear Helm: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.2';
...
g.BlackFlagV3Identity={version:'8.8.13.2-clear-helm',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
