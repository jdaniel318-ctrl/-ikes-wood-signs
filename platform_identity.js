/* Dark Sky 8.8.13.12 — Homeward Bearing: early project-gate customer return authority. */
(function(g){
'use strict';
const BUILD='8.8.13.12';
...
g.BlackFlagV3Identity={version:'8.8.13.12-homeward-bearing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
