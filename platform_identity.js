/* Dark Sky 8.6.56 — Doctrine Authority Repair: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.56';
...
g.BlackFlagV3Identity={version:'8.6.56-admiral-command-rail',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
