/* Dark Sky 8.8.14.14 — Session Current: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.14';
...
g.BlackFlagV3Identity={version:'8.8.14.14-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
