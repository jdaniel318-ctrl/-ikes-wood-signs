/* Dark Sky 8.7.11 — Fixed Bearing: verified identity with guarded iPad screenshot scroll continuity. */
(function(g){
'use strict';
const BUILD='8.7.11';
...
g.BlackFlagV3Identity={version:'8.7.11-fixed-bearing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
