/* Dark Sky 8.8.14.5 — Proof Path: exact customer-experience review course. */
(function(g){
'use strict';
const BUILD='8.8.14.5';
...
g.BlackFlagV3Identity={version:'8.8.14.5-proof-path',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
