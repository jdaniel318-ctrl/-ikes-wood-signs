/* Dark Sky 8.8.13.5 — Proof Lantern: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.5';
...
g.BlackFlagV3Identity={version:'8.8.13.5-proof-lantern',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
