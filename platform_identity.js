/* Dark Sky 8.8.13.14 — Night Watch: visible, reversible command handoffs. */
(function(g){
'use strict';
const BUILD='8.8.13.14';
...
g.BlackFlagV3Identity={version:'8.8.13.14-night-watch',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
