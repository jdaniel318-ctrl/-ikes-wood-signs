/* Dark Sky 8.6.42 — Atomic Seal: identity proves the human; Dark Sky grants fleet authority. */
(function(g){
'use strict';
const BUILD='8.6.42';
...
g.BlackFlagV3Identity={version:'8.6.42-identity-keel',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority};
})(window);
