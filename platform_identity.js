/* Dark Sky 8.8.13.3 — Living Chart: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.3';
...
g.BlackFlagV3Identity={version:'8.8.13.3-living-chart',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
