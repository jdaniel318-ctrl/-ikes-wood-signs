/* Dark Sky 8.8.14.10 — Owner Current: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.10';
...
g.BlackFlagV3Identity={version:'8.8.14.10-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
