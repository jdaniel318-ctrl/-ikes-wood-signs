...
g.BlackFlagV3Identity={version:'3.8.18-immutable-project-identity',ROLE,ACTION,authorize,ownerCan,productionAuth:{ready:false,require:['server_side_identity','password_hashing','secure_sessions','server_side_authorization','recovery','revocation']}};
})(window);