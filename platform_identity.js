/* Dark Sky 8.8.13.6 — True North: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.6';
...
g.BlackFlagV3Identity={version:'8.8.13.6-true-north',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
