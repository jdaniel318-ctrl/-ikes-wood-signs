/* Dark Sky 8.7.14 — Hard Return: capture-phase iPad return with synchronous Engine restoration. */
(function(g){
'use strict';
const BUILD='8.7.14';
...
g.BlackFlagV3Identity={version:'8.7.14-hard-return',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
