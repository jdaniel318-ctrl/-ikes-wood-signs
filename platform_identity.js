/* Dark Sky 8.8.14.8 — Watch Helm: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.8';
...
g.BlackFlagV3Identity={version:'8.8.14.8-watch-helm',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
