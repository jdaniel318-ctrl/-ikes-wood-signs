/* Dark Sky 8.8.13.11 — True Passage: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.11';
...
g.BlackFlagV3Identity={version:'8.8.13.11-true-passage',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
