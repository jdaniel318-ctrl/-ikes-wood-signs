/* Dark Sky 8.8.14.18 — Fleet Velocity: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.18';
...
g.BlackFlagV3Identity={version:'8.8.14.18-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
