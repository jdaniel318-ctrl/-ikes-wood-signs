/* Dark Sky 8.6.54 — Admiral Entitlement States: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.54';
...
g.BlackFlagV3Identity={version:'8.6.54-admiral-entitlement-states',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
