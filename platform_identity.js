/* Dark Sky 8.8.16.1 — Clear Watch: governed Fleet Launch Service. */
(function(g){
'use strict';
const BUILD='8.8.16.1';
...
g.BlackFlagV3Identity={version:'8.8.16.1-report-proof',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
