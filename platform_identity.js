/* Dark Sky 8.6.64 — Recovery Identity Landing: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.64';
...
g.BlackFlagV3Identity={version:'8.6.64-admiral-command-rail',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
