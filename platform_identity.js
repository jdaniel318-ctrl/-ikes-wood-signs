/* Dark Sky 8.8.13.1 — Deck Clearance: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.1';
...
g.BlackFlagV3Identity={version:'8.8.13.1-deck-clearance',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
