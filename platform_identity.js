/* Dark Sky 8.6.48 — RLS Landing: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.48';
...
g.BlackFlagV3Identity={version:'8.6.48-rls-landing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
