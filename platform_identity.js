/* Dark Sky 8.8.13.8 — Fleet Circuit: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.8';
...
g.BlackFlagV3Identity={version:'8.8.13.8-fleet-circuit',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
