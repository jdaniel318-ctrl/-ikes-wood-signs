/* Dark Sky 8.8.13.7 — True Bearing: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.7';
...
g.BlackFlagV3Identity={version:'8.8.13.7-true-bearing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
