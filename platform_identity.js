/* Dark Sky 8.7.12 — Clear Passage: canonical Admiral return with focused iPad controls. */
(function(g){
'use strict';
const BUILD='8.7.12';
...
g.BlackFlagV3Identity={version:'8.7.12-clear-passage',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
