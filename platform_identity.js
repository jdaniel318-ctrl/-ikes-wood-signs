/* Dark Sky 8.6.51 — Owner Bridge: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.51';
...
g.BlackFlagV3Identity={version:'8.6.51-owner-bridge',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
