/* Dark Sky 8.8.2 — Navigation Bulkhead: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.2';
...
g.BlackFlagV3Identity={version:'8.8.2-navigation-bulkhead',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
