/* Dark Sky 8.8.15.9 — Report Proof: governed Fleet Launch Service. */
(function(g){
'use strict';
const BUILD='8.8.15.9';
...
g.BlackFlagV3Identity={version:'8.8.15.9-report-proof',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
