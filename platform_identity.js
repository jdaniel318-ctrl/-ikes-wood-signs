/* Dark Sky 8.6.47 — Fleet Ownership Charter: live staging identity; Dark Sky grants fleet authority. */
(function(g){
'use strict';
const BUILD='8.6.47';
...
g.BlackFlagV3Identity={version:'8.6.47-fleet-ownership-charter',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
