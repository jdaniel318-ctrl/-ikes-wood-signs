/* Dark Sky 8.8.13.13 — Signal Lift: visible Captain signal-report authority. */
(function(g){
'use strict';
const BUILD='8.8.13.13';
...
g.BlackFlagV3Identity={version:'8.8.13.13-homeward-bearing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
