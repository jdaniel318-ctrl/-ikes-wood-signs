/* Dark Sky 8.8.13.9 — Keelbound: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.9';
...
g.BlackFlagV3Identity={version:'8.8.13.9-keelbound',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
