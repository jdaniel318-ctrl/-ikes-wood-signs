/* Dark Sky 8.8.13 — Fleet Rigging: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13';
...
g.BlackFlagV3Identity={version:'8.8.13-fleet-rigging',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
