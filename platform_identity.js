/* Dark Sky 8.7.4 — Command Light: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.7.4';
...
g.BlackFlagV3Identity={version:'8.7.4-command-light',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
