/* Dark Sky 8.7.7 — Steady Command: professional contrast and direct authenticated authority routes. */
(function(g){
'use strict';
const BUILD='8.7.7';
...
g.BlackFlagV3Identity={version:'8.7.7-steady-command',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
