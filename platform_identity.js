/* Dark Sky 8.8.14.6 — Full Frame: exact customer-experience review course. */
(function(g){
'use strict';
const BUILD='8.8.14.6';
...
g.BlackFlagV3Identity={version:'8.8.14.6-full-frame',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
