...
g.BlackFlagV3Identity={version:'8.8.17.3-clear-authority',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
