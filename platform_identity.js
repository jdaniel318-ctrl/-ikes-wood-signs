/* Dark Sky 8.8.15.8 — Fleet Runtime: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.15.8';
...
g.BlackFlagV3Identity={version:'8.8.15.8-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
