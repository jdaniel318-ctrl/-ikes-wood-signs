/* Dark Sky 8.6.43 — Live Identity Staging: live staging identity; Dark Sky grants fleet authority. */
(function(g){
'use strict';
const BUILD='8.6.43';
...
g.BlackFlagV3Identity={version:'8.6.43-live-identity-staging',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority};
})(window);
