/* Dark Sky 8.8.14.1 — True Course: module-safe Captain rendering. */
(function(g){
'use strict';
const BUILD='8.8.14.1';
...
g.BlackFlagV3Identity={version:'8.8.14.1-true-course',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
