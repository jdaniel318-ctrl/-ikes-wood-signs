/* Dark Sky 8.7.5 — Clear Deck: clear operating paths with authenticated exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.7.5';
...
g.BlackFlagV3Identity={version:'8.7.5-clear-deck',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
