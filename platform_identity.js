/* Dark Sky 8.8.13.4 — Constellation: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.4';
...
g.BlackFlagV3Identity={version:'8.8.13.4-constellation',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
