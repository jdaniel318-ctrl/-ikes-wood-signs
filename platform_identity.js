/* Dark Sky 8.8.14.23 — Route Safe: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.23';
...
g.BlackFlagV3Identity={version:'8.8.14.23-owner-current',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
