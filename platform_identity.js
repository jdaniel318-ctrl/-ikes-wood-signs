...
g.BlackFlagV3Identity={version:'8.8.17.9-clear-orders-repair',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
