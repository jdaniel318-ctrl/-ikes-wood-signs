/* Dark Sky 8.8.11.3 — Native Passage: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.11.3';
...
g.BlackFlagV3Identity={version:'8.8.11.3-steady-schedule',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
