/* Dark Sky 8.8.13.10 — Shared Bearing: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.13.10';
...
g.BlackFlagV3Identity={version:'8.8.13.10-shared-bearing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
