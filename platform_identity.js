/* Dark Sky 8.8.14.0 — Fleet Ready: exact operational course without automatic action. */
(function(g){
'use strict';
const BUILD='8.8.14.0';
...
g.BlackFlagV3Identity={version:'8.8.14.0-fleet-ready',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
