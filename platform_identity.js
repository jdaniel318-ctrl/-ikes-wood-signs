/* Dark Sky 8.8.14.9 — Signal Watch: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.9';
...
g.BlackFlagV3Identity={version:'8.8.14.9-signal-watch',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
