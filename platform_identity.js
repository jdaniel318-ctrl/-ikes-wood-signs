/* Dark Sky 8.7.6 — Command Clarity: professional contrast and direct authenticated authority routes. */
(function(g){
'use strict';
const BUILD='8.7.6';
...
g.BlackFlagV3Identity={version:'8.7.6-command-clarity',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
