/* Dark Sky 8.8.11.9 — Native Passage: shell-owned upper-command escape authority. */
(function(g){
'use strict';
const BUILD='8.8.11.9';
...
g.BlackFlagV3Identity={version:'8.8.11.9-registry-passage',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
