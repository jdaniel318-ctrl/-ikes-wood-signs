/* Dark Sky 8.6.52 — Owner Bridge Core: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.52';
...
g.BlackFlagV3Identity={version:'8.6.52-owner-bridge',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
