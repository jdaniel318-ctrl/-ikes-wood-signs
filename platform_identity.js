/* Dark Sky 8.8.14.7 — True Watch: source-aware Admiral observability. */
(function(g){
'use strict';
const BUILD='8.8.14.7';
...
g.BlackFlagV3Identity={version:'8.8.14.7-true-watch',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
