/* Dark Sky 8.8.14.4 — Visible Arrival: visible native Engine deployment handoff. */
(function(g){
'use strict';
const BUILD='8.8.14.4';
...
g.BlackFlagV3Identity={version:'8.8.14.4-true-course',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
