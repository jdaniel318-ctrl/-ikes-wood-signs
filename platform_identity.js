/* Dark Sky 8.6.49 — Owner Password Setup: authenticated read capability with exact-vessel RLS authority. */
(function(g){
'use strict';
const BUILD='8.6.49';
...
g.BlackFlagV3Identity={version:'8.6.49-rls-landing',build:BUILD,ROLE,ACTION,authorize,ownerCan,productionAuth,commissioningAuthority,ownershipCharter};
})(window);
