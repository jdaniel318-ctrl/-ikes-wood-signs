(() => {
  ...
  const UPPER_COMMAND_BUILD='8.8.10';
...
/* 8.8.10 Fleet Door Repair — canonical vessel identity, Admiral-controlled. */
;(()=>{
...
/* 8.8.10 Bootstrap Build — local-first construction schedule proving ground. */
;(()=>{
...
/* 8.8.10 Fleet Door Repair — permanent keel, editable working name. */
;(()=>{
  const SESSION_KEY='darkSkySupabaseAdmiralSessionV1';
