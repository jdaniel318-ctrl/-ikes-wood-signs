(() => {
  ...
  function prepareCinematicCabin(){
    ...
    // 5.8.2 HELM FIX: Captain's Quarters mode must never depend on an image
    ...
    image.onerror=()=>{
      ...
      if(bg) bg.style.backgroundImage="linear-gradient(90deg,rgba(2,9,12,.78) 0 13%,rgba(2,9,12,.18) 27% 70%,rgba(2,9,12,.76) 88% 100%),linear-gradient(180deg,rgba(2,7,10,.42),transparent 28%,rgba(2,7,10,.52)),url('assets/captains_quarters_helm_sunset_v582.png')";
    };
    image.src='assets/captains_quarters_helm_sunset_v582.png?v=5.8.2';
  }
