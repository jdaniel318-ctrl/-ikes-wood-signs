/* 8.8.11.4 Natural Schedule — a full document load must never inherit
...
;(() => {
  ...
  window.DarkSkyAdmiralFreshGate=Object.freeze({build:'8.8.11.4',requiredPerDocument:true,engineAuthoritySeparate:true});
})();
...
(() => {
  ...
  const UPPER_COMMAND_BUILD='8.8.11.4';
