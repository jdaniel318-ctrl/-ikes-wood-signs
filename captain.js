/* 8.8.13.10 Shared Bearing — a full document load must never inherit
...
;(() => {
  ...
  window.DarkSkyAdmiralFreshGate=Object.freeze({build:'8.8.13.10',requiredPerDocument:true,engineAuthoritySeparate:true});
})();
/* Dark Sky 8.8.13.10 Shared Bearing — read-only Admiral observability. */
;(()=>{
...
(() => {
  ...
  const UPPER_COMMAND_BUILD='8.8.13.10';
