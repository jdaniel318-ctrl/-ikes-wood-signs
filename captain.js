    ...
    if(!surface){
      ...
      surface.innerHTML=`
        ...
        <section class="captain-command-decks" aria-label="Captain command loop">
          ...
          <article class="captain-command-lane"><header><small>04 · RECORD</small><h3>Keep the decision.</h3><p>Orders, notes, history, outcomes and retained lessons.</p></header><button id="captainAuthorityLedgerOpen" class="captain-primary-action" type="button">OPEN AUTHORITY LEDGER</button><div id="captainProRecordItems" class="captain-lane-body"></div></article>
        </section>
