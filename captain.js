      ...
      <div class="admiral-deck-shell">
        ...
        <main class="admiral-deck-grid" aria-label="Admiral professional command view">
          ...
          <section class="admiral-lane-workspace" aria-live="polite">
            ...
            <article data-admiral-panel="standardize" hidden><small>02 · STANDARDIZE</small><h4>Doctrine & standards</h4><p>Fleet doctrine, compliance, exceptions and policy versions.</p><div class="admiral-lane-summary"><b>Fleet Doctrine Registry</b><span>Active fleet rules remain versioned, traceable and separated from current incident posture.</span></div><button id="admiralDeckStandards" type="button">OPEN FLEET STANDARDS <em>FOUNDATION</em></button><div class="admiral-lane-summary admiral-service-governance"><b>Fleet Service Entitlements</b><span>Admiral sets each capability as Standard or Paid. Owners may request paid upgrades, but only server-governed Admiral authority can grant or enable them.</span></div><button id="admiralServiceEntitlements" type="button">SERVICE ENTITLEMENTS <em>SERVER-GOVERNED</em></button></article>
...
;(()=>{const b=document.getElementById('admiralServiceEntitlements');if(b)b.addEventListener('click',()=>{const n=document.getElementById('admiralDeckNotice');if(n)n.textContent='Fleet Service Entitlements are server-governed. Browser controls cannot grant vessel authority without authenticated Admiral identity.';});})();
