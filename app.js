...
,
  ...
  async function routeClientPreviewFromHash(){
    ...
    // 5.7.8 Client Preview Isolation Bulkhead: the sealed preview is a standalone
...
The full order and approved media remain stored with this project.`;
  ...
  async function init(){
    // 5.7.8: sealed Client Preview links route before storage, migrations, fleet
