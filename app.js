(() => {
  ...
  function renderTestAccessState(){
    ...
    const deckStatus=document.getElementById('captainTestAccessDeckStatus'); if(deckStatus)deckStatus.textContent=active?'ACTIVE • PIN ENTRY BYPASSED':'OFF • NORMAL SECURITY';
