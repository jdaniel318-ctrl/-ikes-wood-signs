/* Dark Sky 8.4.3 — Ike Style Foundry
...
(()=>{
  ...
  const packs={
    A:{
      ...
      anchorText:'RAMJET',anchorImage:'ike_style_a_ramjet_reference.jpg',anchorSource:'bundled-production',geometryCertificationBasis:'bundled-anchor',
    ...
    B:{
      ...
      anchorText:'SMOKE HOLE!',anchorImage:'ike_style_b_smoke_hole_reference.jpg',anchorSource:'bundled-production',geometryCertificationBasis:'bundled-anchor',
      authority:'real-finished-sign',renderer:'companion-profile',
  ...
  const api={schema:'dark-sky-ike-style-foundry-v4',build:'8.4.3',release:'GlyphForge',packs,pack,coverage,chars}; window.IkeGlyphForge=api; window.IkeGlyphBench=api;
})();
