...
**Current release:** v3.8.3 — Identity Sync & Order Command Refit
...
- Cache/version references advanced to v3.8.3 for iPad/Safari deployment.
...
## Deployment
Upload the contents of this folder together, preserving `assets/`. GitHub Pages may need one refresh while the v3.8.3 service worker replaces the previous cache.
