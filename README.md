...
**Current release:** v3.8.7 — Command Navigation Refit
...
- Cache/version references advanced to v3.8.7 for iPad/Safari deployment.
...
## Deployment
Upload the contents of this folder together, preserving `assets/`. GitHub Pages may need one refresh while the v3.8.7 service worker replaces the previous cache.
...
Engine Fleet Health, expanded rule-based attention, and consistent Project Control module framing prepare the ship for 3.9 Operating Models.
