...
**Current release:** v3.8.4 — Command Navigation Refit
...
- Cache/version references advanced to v3.8.4 for iPad/Safari deployment.
...
## Deployment
Upload the contents of this folder together, preserving `assets/`. GitHub Pages may need one refresh while the v3.8.4 service worker replaces the previous cache.
