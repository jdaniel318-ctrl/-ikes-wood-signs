...
- Fixes surface-dependent TrueCase readiness so Admiral does not falsely HOLD because the Customer DOM is not open.
- Adds direct action controls to Admiral HOLD/WATCH findings.
- Adds Engine origin-storage growth as a readiness WATCH/hold threshold.
...
- Adds What Changed, Fleet Status at a Glance, and a subordinate Captain Tools deck.
- Reorganizes Admiral Professional Command into Govern → Standardize → Delegate → Promote, with Continuity separated from command.
