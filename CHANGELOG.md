...
- Keeps the release at 85 files with canonical identity 8.8.14.22 / route-safe-881422.
...
- Aligns document, deployment manifest, service worker, release gate, inventory, PWA manifest, and runtime seal to one canonical identity: 8.8.14.22 / route-safe-881422.
...
# Dark Sky 8.8.14.22 — Session Current
